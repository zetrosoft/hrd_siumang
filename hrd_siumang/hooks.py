...
override_doctype_class = {
	...
	"Salary Slip": "hrd_siumang.hrd_siumang.overrides.custom_salary_slip.CustomSalarySlip",
	"Payroll Entry": "hrd_siumang.hrd_siumang.overrides.custom_payroll_entry.CustomPayrollEntry",
}
...
doc_events = {
	"Job Requisition": {"on_update": "hrd_siumang.hrd_siumang.doc_events.job_requisition_events.on_update"},
	"Overtime Planning": {
		"on_update": "hrd_siumang.hrd_siumang.doc_events.overtime_planning_events.on_update_or_submit"
	},
	"Employee Advance": {
		"on_update": "hrd_siumang.hrd_siumang.doc_events.employee_advance_events.send_notification_on_state_change"
	},
	"Salary Slip": {
		"before_save": "hrd_siumang.hrd_siumang.payroll.salary_slip_events.calculate_payroll_components"
	},
	"Salary Structure Assignment": {
		"before_save": "hrd_siumang.hrd_siumang.overrides.salary_structure_assignment.set_base_from_ctc"
	},
}
