...
def rollback_ter_doctype(dry_run=False):
	"""Menghapus DocType Tarif Efektif Rerata."""
	doctype_name = "Tarif Efektif Rerata"
...
def test_rollback():
	...
	rollback_step0_slips(dry_run=True)  # Tambahkan ini
...
def run_full_rollback():
	...
	rollback_step0_slips(dry_run=False)  # Tambahkan ini
